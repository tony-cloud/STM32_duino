...
const stm32_tim_pin_list_type chip_tim1 [] = {
    ...
    { TIM1  ,GPIOA, GPIO_PIN_11 ,TIM_BKIN2  , GPIO_AF2_TIM1  }, 
    { TIM1  ,GPIOE, GPIO_PIN_14 ,TIM_BKIN2  , GPIO_AF2_TIM1  }, 
    { TIM1  ,GPIOA, GPIO_PIN_11 ,TIM_BKIN2  , GPIO_AF12_COMP1}, 
    { TIM1  ,GPIOE, GPIO_PIN_14 ,TIM_BKIN2  , GPIO_AF3_TIM1_COMP2}, 
    { TIM1  ,GPIOE, GPIO_PIN_15 ,TIM_BKIN   , GPIO_AF3_TIM1_COMP1}, 
    { TIM1  ,GPIOA, GPIO_PIN_6  ,TIM_BKIN   , GPIO_AF12_COMP2}, 
    { TIM1  ,GPIOB, GPIO_PIN_12 ,TIM_BKIN   , GPIO_AF3_TIM1_COMP2}, 
...
const stm32_tim_pin_list_type chip_tim2 [] = {
    ...
    { TIM2  ,GPIOA, GPIO_PIN_0  ,TIM_ETR    , GPIO_AF2_TIM2  }, /*fix me?*/
...
const stm32_tim_pin_list_type chip_tim3 [] = {
    ...
    { TIM3  ,GPIOE, GPIO_PIN_3  ,TIM_CH1    , GPIO_AF2_TIM3  }, 
...
const stm32_tim_pin_list_type chip_tim5 [] = {
    ...
    { TIM5  ,GPIOF, GPIO_PIN_6  ,TIM_CH1    , GPIO_AF2_TIM5  }, 
    { TIM5  ,GPIOA, GPIO_PIN_1  ,TIM_CH2    , GPIO_AF2_TIM5  }, 
    { TIM5  ,GPIOF, GPIO_PIN_7  ,TIM_CH2    , GPIO_AF2_TIM5  }, 
    { TIM5  ,GPIOA, GPIO_PIN_2  ,TIM_CH3    , GPIO_AF2_TIM5  }, 
    { TIM5  ,GPIOF, GPIO_PIN_8  ,TIM_CH3    , GPIO_AF2_TIM5  }, 
    { TIM5  ,GPIOA, GPIO_PIN_3  ,TIM_CH4    , GPIO_AF2_TIM5  }, 
    { TIM5  ,GPIOF, GPIO_PIN_9  ,TIM_CH4    , GPIO_AF2_TIM5  }, 
    { TIM5  ,GPIOF, GPIO_PIN_6  ,TIM_ETR    , GPIO_AF1_TIM5  }, 
}; 
...
const stm32_tim_pin_list_type chip_tim8 [] = {
    ...
    { TIM8  ,GPIOB, GPIO_PIN_7  ,TIM_BKIN   , GPIO_AF3_TIM8  }, 
    { TIM8  ,GPIOB, GPIO_PIN_6  ,TIM_BKIN2  , GPIO_AF3_TIM8  }, 
    { TIM8  ,GPIOC, GPIO_PIN_9  ,TIM_BKIN2  , GPIO_AF1_TIM8  }, 
//    { TIM8  ,GPIOC, GPIO_PIN_9  ,TIM_BKIN2  , GPIO_AF14_TIM8_COMP1}, 
    { TIM8  ,GPIOB, GPIO_PIN_6  ,TIM_BKIN2  , GPIO_AF12_COMP2}, 
    { TIM8  ,GPIOB, GPIO_PIN_7  ,TIM_BKIN   , GPIO_AF13_TIM8_COMP1}, 
//    { TIM8  ,GPIOA, GPIO_PIN_6  ,TIM_BKIN   , GPIO_AF13_TIM8_COMP2}, 
...
const stm32_tim_pin_list_type chip_tim15 [] = {
    { TIM15 ,GPIOA, GPIO_PIN_9  ,TIM_BKIN   , GPIO_AF14_TIM15}, 
    { TIM15 ,GPIOB, GPIO_PIN_12 ,TIM_BKIN   , GPIO_AF14_TIM15}, 
    { TIM15 ,GPIOA, GPIO_PIN_2  ,TIM_CH1    , GPIO_AF14_TIM15}, 
    { TIM15 ,GPIOB, GPIO_PIN_14 ,TIM_CH1    , GPIO_AF14_TIM15}, 
    { TIM15 ,GPIOF, GPIO_PIN_9  ,TIM_CH1    , GPIO_AF14_TIM15}, 
    { TIM15 ,GPIOG, GPIO_PIN_10 ,TIM_CH1    , GPIO_AF14_TIM15}, 
    { TIM15 ,GPIOA, GPIO_PIN_1  ,TIM_CH1N   , GPIO_AF14_TIM15}, 
    { TIM15 ,GPIOB, GPIO_PIN_13 ,TIM_CH1N   , GPIO_AF14_TIM15}, 
    { TIM15 ,GPIOG, GPIO_PIN_9  ,TIM_CH1N   , GPIO_AF14_TIM15}, 
    { TIM15 ,GPIOA, GPIO_PIN_3  ,TIM_CH2    , GPIO_AF14_TIM15}, 
    { TIM15 ,GPIOB, GPIO_PIN_15 ,TIM_CH2    , GPIO_AF14_TIM15}, 
    { TIM15 ,GPIOF, GPIO_PIN_10 ,TIM_CH2    , GPIO_AF14_TIM15}, 
    { TIM15 ,GPIOG, GPIO_PIN_11 ,TIM_CH2    , GPIO_AF14_TIM15}, 
}; 

const stm32_tim_pin_list_type chip_tim16 [] = {
    { TIM16 ,GPIOB, GPIO_PIN_5  ,TIM_BKIN   , GPIO_AF14_TIM16}, 
    { TIM16 ,GPIOA, GPIO_PIN_6  ,TIM_CH1    , GPIO_AF14_TIM16}, 
    { TIM16 ,GPIOB, GPIO_PIN_8  ,TIM_CH1    , GPIO_AF14_TIM16}, 
    { TIM16 ,GPIOE, GPIO_PIN_0  ,TIM_CH1    , GPIO_AF14_TIM16}, 
    { TIM16 ,GPIOB, GPIO_PIN_6  ,TIM_CH1N   , GPIO_AF14_TIM16}, 
}; 

const stm32_tim_pin_list_type chip_tim17 [] = {
    { TIM17 ,GPIOA, GPIO_PIN_10 ,TIM_BKIN   , GPIO_AF14_TIM17}, 
    { TIM17 ,GPIOB, GPIO_PIN_4  ,TIM_BKIN   , GPIO_AF14_TIM17}, 
    { TIM17 ,GPIOA, GPIO_PIN_7  ,TIM_CH1    , GPIO_AF14_TIM17}, 
    { TIM17 ,GPIOB, GPIO_PIN_9  ,TIM_CH1    , GPIO_AF14_TIM17}, 
    { TIM17 ,GPIOE, GPIO_PIN_1  ,TIM_CH1    , GPIO_AF14_TIM17}, 
    { TIM17 ,GPIOB, GPIO_PIN_7  ,TIM_CH1N   , GPIO_AF14_TIM17}, 
}; 
...
const stm32_tim_pin_list_type chip_tim [] = {
    ...
    { TIM2  ,GPIOA, GPIO_PIN_3  ,TIM_CH4    , GPIO_AF1_TIM2  }, 
    { TIM2  ,GPIOB, GPIO_PIN_11 ,TIM_CH4    , GPIO_AF1_TIM2  }, 
//    { TIM2  ,GPIOA, GPIO_PIN_0  ,TIM_ETR    , GPIO_AF14_TIM2 }, 
    { TIM2  ,GPIOA, GPIO_PIN_5  ,TIM_ETR    , GPIO_AF2_TIM2  }, 
    { TIM2  ,GPIOA, GPIO_PIN_15 ,TIM_ETR    , GPIO_AF2_TIM2  }, 
    { TIM3  ,GPIOA, GPIO_PIN_6  ,TIM_CH1    , GPIO_AF2_TIM3  }, 
    { TIM3  ,GPIOB, GPIO_PIN_4  ,TIM_CH1    , GPIO_AF2_TIM3  }, 
