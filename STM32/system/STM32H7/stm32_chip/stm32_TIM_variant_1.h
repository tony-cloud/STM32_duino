...
const stm32_tim_pin_list_type chip_tim1 [] = {
    ...
    { TIM1  ,GPIOE, GPIO_PIN_6  ,TIM_BKIN2  , GPIO_AF1_TIM1  }, 
...
const stm32_tim_pin_list_type chip_tim8 [] = {
    ...
    { TIM8  ,GPIOA, GPIO_PIN_8  ,TIM_BKIN2  , GPIO_AF3_TIM8  }, 
...
const stm32_tim_pin_list_type chip_tim12 [] = {
    { TIM12 ,GPIOB, GPIO_PIN_14 ,TIM_CH1    , GPIO_AF2_TIM12 }, 
    { TIM12 ,GPIOB, GPIO_PIN_15 ,TIM_CH2    , GPIO_AF2_TIM12 }, 
}; 
