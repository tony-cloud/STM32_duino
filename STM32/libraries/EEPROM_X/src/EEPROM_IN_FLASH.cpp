...
#include "FlashVariables.h"
    ...
    #warning "Using exten 8K of flash for EEPROM emulation"

    #include "STM32F1FlashBlock.h"

    STM32F1EmbeddedFlashBlock block0(FLASH_LENGTH + 0        , 32 * 1024);
    STM32F1EmbeddedFlashBlock block1(FLASH_LENGTH + 32 * 1024, 32 * 1024);
