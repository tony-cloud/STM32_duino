...
#define EXTRAM_Read_8b   HAL_SDRAM_Read_8b
#define EXTRAM_Read_16b  HAL_SDRAM_Read_16b
#define EXTRAM_Read_32b  HAL_SDRAM_Read_32b
#define EXTRAM_Write_8b  HAL_SDRAM_Write_8b
#define EXTRAM_Write_16b HAL_SDRAM_Write_16b
#define EXTRAM_Write_32b HAL_SDRAM_Write_32b
...
#define EXTRAM_Read_8b   HAL_SRAM_Read_8b
#define EXTRAM_Read_16b  HAL_SRAM_Read_16b
#define EXTRAM_Read_32b  HAL_SRAM_Read_32b
#define EXTRAM_Write_8b  HAL_SRAM_Write_8b
#define EXTRAM_Write_16b HAL_SRAM_Write_16b
#define EXTRAM_Write_32b HAL_SRAM_Write_32b
...
class STM32EXTRAM
{
  ...
  public:
    ...
    inline uint8_t readData( uint32_t uwStartAddress, uint8_t *pData, uint32_t uwDataSize) {
      return EXTRAM_Read_8b(&EXTRAM_Handle, (uint32_t *)(uwStartAddress + EXTRAM_START), pData, uwDataSize);
    };
    inline uint8_t readData( uint32_t uwStartAddress, uint16_t *pData, uint32_t uwDataSize) {
      return EXTRAM_Read_16b(&EXTRAM_Handle, (uint32_t *)(uwStartAddress + EXTRAM_START), pData, uwDataSize);
    };
    inline uint8_t readData( uint32_t uwStartAddress, uint32_t *pData, uint32_t uwDataSize) {
      return EXTRAM_Read_32b(&EXTRAM_Handle, (uint32_t *)(uwStartAddress + EXTRAM_START), pData, uwDataSize);
    };
    inline uint8_t writeData(uint32_t uwStartAddress, uint8_t *pData, uint32_t uwDataSize) {
      return EXTRAM_Write_8b(&EXTRAM_Handle, (uint32_t *)(uwStartAddress + EXTRAM_START), pData, uwDataSize);
    };
    inline uint8_t writeData(uint32_t uwStartAddress, uint16_t *pData, uint32_t uwDataSize) {
      return EXTRAM_Write_16b(&EXTRAM_Handle, (uint32_t *)(uwStartAddress + EXTRAM_START), pData, uwDataSize);
    };

    inline uint8_t writeData(uint32_t uwStartAddress, uint32_t *pData, uint32_t uwDataSize) {
      return EXTRAM_Write_32b(&EXTRAM_Handle, (uint32_t *)(uwStartAddress + EXTRAM_START), pData, uwDataSize);
    };

    template<typename T>
    T *getRamBaseAddress() {
      return reinterpret_cast<T *>(EXTRAM_START);
    }
    ...
    inline void setHeapAtExtRam(void) {
      setHeap((unsigned char*)EXTRAM_START, (unsigned char*)EXTRAM_START + EXTRAM_LENGTH);
    }
...
#if  defined(USE_EXTRAMSYSMALLOC) && (USE_EXTRAMSYSMALLOC == 0)
